...
public class MyLinkedListTester {
	...
	{
		assertEquals(true, emptyList.add(2000));
		assertEquals((Integer) 2000, emptyList.get(0));
		assertEquals(1, emptyList.size());

		assertEquals(true, emptyList.add(3000));
		assertEquals((Integer) 3000, emptyList.get(1));
